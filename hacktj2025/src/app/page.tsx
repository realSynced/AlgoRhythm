            ...
            >
              <div>
                ...
                <p className="text-neutral-400">
                  AI-powered audio to MIDI conversion for single instrument
                  tracks. Locally processes audio data in Hz, using Discrete
                  Fourier Transform to detect distinct pitches, and separates
                  instruments with a machine learning model.
                </p>
              </div>
              <div>
                <h3 className="text-2xl font-semibold mb-3 flex items-center">
